...
class LazySelect(object):
    def __call__(self, field, **kwargs):
        return list((val, unicode(label), selected)
...
class QuerySelectFieldTest(TestBase):
    ...
    def test_without_factory(self):
        ...
        class F(Form):
            a = QuerySelectField(get_label='name', widget=LazySelect(),
        ...
        self.assertEqual(form.a(), [(u'1', 'apple', True),
            (u'2', 'banana', False)])
    ...
    def test_with_query_factory(self):
        ...
        self.assertEqual(form.a(), [(u'1', 'apple', False),
            (u'2', 'banana', False)])
        self.assertEqual(form.b.data, None)
        self.assertEqual(form.b(), [(u'__None', '', True),
            (u'hello1', 'apple', False), (u'hello2', 'banana', False)])
        ...
        self.assertEqual(form.b(), [(u'__None', '', False),
            (u'hello1', 'apple', False), (u'hello2', 'banana', True)])
        self.assert_(form.validate())
        ...
        self.assertEqual(form.a(), [(u'1', 'apple', True),
            (u'2', 'banana', False), (u'3', 'meh', False)])
...
class QuerySelectMultipleFieldTest(TestBase):
    ...
    def test_single_default_value(self):
        ...
        class F(Form):
            a = QuerySelectMultipleField(get_label='name',
                default=[first_test], widget=LazySelect(),
